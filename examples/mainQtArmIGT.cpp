...
int main(int argc, char ** argv)
{
    ...
    // OpenIGTLink
    mtsOpenIGTLinkBridge * igtBridge = new mtsOpenIGTLinkBridge("igt", 20.0 * cmn_ms);
    igtBridge->Configure("18944");
    componentManager->AddComponent(igtBridge);
    componentManager->Connect(igtBridge->GetName(), "requiresPositionCartesian",
                              arm->Name(), "Robot");
